    ...
    return (
        <div className='bg-amber-100 h-screen font-mono'>
            <form className='grid justify-items-center gap-4 place-items-center'>
                ...
                <input className='rounded-lg' onChange={e => setUser({ ...user, name: e.target.value })} type="text" placeholder="Name" />
                <input className='rounded-lg' onChange={e => setUser({ ...user, surname: e.target.value })} type="text" placeholder="Surname" />
